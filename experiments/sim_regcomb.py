    ...
    if axes:
        ...
        if len(axes) == 2:
            ...
            for score_name in summary_df["score"].unique():
                ...
                ax.set_title(make_heatmap_title(axes[0], axes[1], score_name, sub), fontsize=16, fontweight='bold')
                ...
                arrow_ax.set_title(f"{arrow_title} (descent directions)", fontsize=16, fontweight='bold')
